    ...
    return function r(e, n, t) {
        function o(a, u) {
            if (!n[a]) {
                ...
                e[a][0].call(f.exports, function(n) {
                    var t = e[a][1][n];
                    return o(t ? t : n);
                }, f, f.exports, r, e, n, t);
            }
        ...
        "/home/masud/projects/dragula/dragula.js": [ function(e, n, t) {
            (function(t) {
                ...
                var o = e("crossvent");
                var i = e("./classes");
                var a = window.Polymer.dom || function(e) {
                    return e;
                };
                var u = window.Polymer.Gestures || function(e) {
                    return e;
                };
                function s(e, n) {
                    ...
                    function Q(e) {
                        ...
                        if (f === null || f !== i && f !== h(i) && f !== N) {
                            N = f;
                            console.log("item:", i);
                            console.log("target:", u);
                            console.log("reference", f);
                            console.log("immediate", v);
                            u.insertBefore(i, f);
                            T.emit("shadow", i, u);
                        }
                        function m(e) {
                    ...
                    function ee() {
                        ...
                        i.rm(s, "gu-transit");
                        i.add(s, "gu-mirror");
                        a(S.mirrorContainer).appendChild(s);
                        c(u, "add", "mousemove", Q);
